/* This file was adapted to this project by converting to typescript:
 * - Adding a namespace
 * - Changing return type on getRepoPath to string
 * - Replace isReserved with custom implementation
 */

// We don't use NPM ATM and we don't need to be too careful so
// so we replace the old module and hard-code a constant.
// import {check as isReserved} from 'github-reserved-names';
function isReserved(ownerRepo: string): boolean {
    return false;
}

namespace PageDetect {
